...
main();
async function main() {
    const daisyUser = new tweeter_shared_1.User("Daisy", "Duck", mainUsername, "https://faculty.cs.byu.edu/~jwilkerson/cs340/tweeter/images/daisy_duck.png");
    await fillUserTableDao.createUsers([daisyUser], "password");
